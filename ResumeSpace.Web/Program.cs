...
using ResumeSpace.Business.Configurations;
using ResumeSpace.Model.Models;
using Microsoft.AspNetCore.Identity;
using ResumeSpace.EmailService.Configuration;
using ResumeSpace.EmailService.Abstract;
using ResumeSpace.EmailService.Concrete;

namespace ResumeSpace.Blog
{
